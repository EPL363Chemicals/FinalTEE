...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2015 at 04:01 PM
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `Commersial_Name` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `containschemical` (
  ...
  `QuantityType` varchar(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `CLPh` varchar(250) NOT NULL,
  `CLPp` varchar(250) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `usertee`
--
...
--
ALTER TABLE `company`
 ADD PRIMARY KEY (`Commersial_Name`);
