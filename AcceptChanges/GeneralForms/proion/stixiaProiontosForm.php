...
include "../../connectToDBforRead.php";
       ...
       /*SELECT DISTINCT product.*,supply.Address FROM `product`,`supply` Where product.Commercial_Name='Χλορίνη'and product.SavingDate="2015-05-06" and supply.Product='Χλορίνη'and supply.Saving_Date='2015-05-06'*/
...
<script>
    ...
    $(document).ready(function() {
     ...
     $('#select-H').multiselect({
        ...
        onChange: function(element, checked) {
         ...
         $('#chemicalProduct_Name').val("<?php echo $row1['Chemical_Name'];?>");
            $('#chemicalProduct_CommName').val("<?php echo $row1['Commercial_Name'];?>");
            $('#chemicalProduct_use').val("<?php echo $row1['Uses'];?>");
            $('#chemicalProduct_extraChar').val("<?php echo $row1['info'];?>");
            $('#chemicalProduct_state').val("<?php echo $row1['State'];?>");
            $('#chemicalProduct_storageAdd').val("<?php echo $row1['Address'];?>");
            $('#chemicalProduct_SDS').val("<?php echo $row1['Sds'];?>");
            $('#chemicalProduct_V').val("<?php echo $row1['Volume'];?>");
            $('#chemicalProduct_V_Type').val("<?php echo $row1['VoluemType'];?>");
            strH="<?php echo $row1['CLPh'];?>".split(",");
            strP="<?php echo $row1['CLPp'];?>".split(",");
        <?php
                $token = strtok($row1['CLPicon'], ",");
    ...
    $token = strtok(",");
            ...
            $strh=split(",",$row1['CLPh']);
            $i=0;
            while($i<sizeof($strh)){
          ?>
                $('#select-H').multiselect('select',"<?php  echo $strh[$i];?>");
         <?php 
                $i++;
            }
         ?>
          <?php
            $strp=split(",",$row1['CLPp']);
            $i=0;
            while($i<sizeof($strp)){
          ?>    
                $('#select-P').multiselect('select',"<?php  echo $strp[$i];?>");
         <?php 
                $i++;
            }
         ?>
...
<!--                        <input type="text" class="form-control" name="chemicalProduct_CPL" required=true id="chemicalProduct_CPL" />-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <img src="../../DangerIcons/acid_red.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon1" id="icon1" <?php echo $icon1;?>>
                            <img src="../../DangerIcons/Aquatic-pollut-red.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon2" id="icon2" <?php echo $icon2;?>>
                            <img src="../../DangerIcons/bottle.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon3" id="icon3" <?php echo $icon3;?>>
                            <img src="../../DangerIcons/exclam.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon4" id="icon4" <?php echo $icon4;?>>
                            <img src="../../DangerIcons/explos.gif" style="height:50px; width:50px ;margin:10px"><input type="checkbox" name="icon5" id="icon5"  <?php echo $icon5;?>>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-sm-3"></div>
                        <div class="col-md-6">
                            <img src="../../DangerIcons/flamme.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon6" id="icon6" <?php echo $icon6;?>>
                            <img src="../../DangerIcons/rondflam.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon7" id="icon7" <?php echo $icon7;?>>
                            <img src="../../DangerIcons/silhouete.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon8" id="icon8" <?php echo $icon8;?>>
                            <img src="../../DangerIcons/skull.gif" style="height:50px; width:50px ;margin:10px" ><input type="checkbox" name="icon9" id="icon9" <?php echo $icon9;?>>
                        </div>
                    </div>
                </div>
